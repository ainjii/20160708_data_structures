def unique_houses(filename):
    ...
    # houses = {line.split('|')[2] for line in student_file if line.split('|')[2] != ""}
...
def sort_by_cohort(filename):
    ...
    all_students = [sorted(the_list) for the_list in all_students]
...
def students_by_house(filename):
    ...
    for line in student_file:
        ...
        if house == 'Gryffindor':
            ...
            order_of_the_phoenix.append(last)
        elif cohort == 'TA':
            tas.append(last)
        elif cohort == 'I':
...
def find_cohort_by_student_name(student_list):
    ...
    name = raw_input("Please enter the full name of the student you would like to search for: ")
...
def find_name_duplicates(filename):
    ...
    for student in student_file:
        first, last, house, advisor, cohort = student.rstrip().split('|')
        if cohort == 'Winter 2015':
            winter_15.add(first)
        elif cohort == 'Spring 2015':
            spring_15.add(first)
            ...
            summer_15.add(first)
    duplicate_names = winter_15 & spring_15
    duplicate_names = duplicate_names & summer_15
